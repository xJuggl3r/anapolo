...
def main():
    actions = OrderedDict([
        ...
        ("GetETHOverTime", {
            'function': analyzer.get_ETH_over_time,
            'help': 'Public function: Returns percent change over a series of time periods for currencies exceeding a volume threshold in ETH market'
        }),
        ("GetXMROverTime", {
            'function': analyzer.get_XMR_over_time,
            'help': 'Public function: Returns percent change over a series of time periods for currencies exceeding a volume threshold in XMR market'
        }),
	("GetUSDTOverTime", {
            'function': analyzer.get_USDT_over_time,
            'help': 'Public function: Returns percent change over a series of time periods for currencies exceeding a volume threshold in XMR market'
        })
    ])
